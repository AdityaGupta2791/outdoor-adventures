    ...
    <section className="px-6 py-20">
      <div className="max-w-7xl mx-auto">
        <div className="relative rounded-2xl overflow-hidden shadow-sm ring-1 ring-black/5">
          ...
          <div className="relative px-6 sm:px-12 py-20 sm:py-24 text-center text-white">
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-semibold leading-tight max-w-3xl mx-auto">
              {headline}
            </h2>
